...
export default function LearnCard({currentCard, queueMode, termMode}: LearnCardProps) {
    ...
    return(<div className={"w-full h-130 rounded-4xl border border-gray-300 dark:border-studoborder/30 bg-studogrey/30 shadow-xl p-5 gap-5 flex flex-col justify-between items-center"}>
        <div className={'w-full min-h-12 gap-2 rounded-2xl flex flex-row items-center'}>
            <div className={'w-full h-12 dark:text-white bg-studogrey/20 shadow-xl font-bold cursor-pointer rounded-full flex  items-center px-5'}>
                Definitie
            </div>
        ...
        <div className={'min-h-20 w-full flex flex-col gap-2'}>
            ...
            <div className={"bg-gray-300/20 border group focus-within:border-gray-300 border-transparent group focus-within:dark:border-studoborder/30 dark:bg-studogrey/20 px-5  flex items-center rounded-2xl w-full h-full"}>
                <input type="text" placeholder={"type term"} className={"w-full group h-full outline-none"}/>
            </div>
        </div>
    </div>
    )
