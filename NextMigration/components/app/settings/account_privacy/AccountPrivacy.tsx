            ...
            <div className={"w-full border-b gap-4 border-studoborder px-10 py-8 flex flex-col"}>
                <div className={"w-full flex flex-row justify-between items-center"}>
                    <div className={"w-full h-fit flex flex-col gap-3"}>
                        <span className={"w-full text-base font-bold h-fit"}>{t("request_verf")}</span>
                        <span className={"text-sm"}>{t("request_subt")}</span>
                    </div>
                    <button
                        className={"font-bold cursor-pointer px-5 py-2 rounded-4xl bg-gray-500"}>{t("request")}</button>
                </div>
            </div>
