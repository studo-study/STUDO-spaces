...
export default function StudyGroupPage() {
    const t = useTranslations("landing.classrooms.studygroup")
    ...
    return (
        <main className={`w-full dark:text-white text-studodarkblue
          ...
          bg-gradient-to-b from-transparent via-transparent to-blue-400/40`}>
                        ...
                        {launched &&
							<AnimateOnMount delay={1000} className={"w-full"}>
								<div className={`w-full flex items-center justify-baseline transition-all duration-700 delay-1000`}>
									<Link href="/register" className="px-6 py-3 rounded-full flex items-center justify-center text-white bg-violet-400 font-bold">
                                        {t("cta")}
									</Link>
								</div>
							</AnimateOnMount>}
