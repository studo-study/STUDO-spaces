            ...
            <div className={"w-full min-h-screen flex items-center flex-col gap-10"}>
                ...
                <AnimateOnMount delay={400} className={"w-2/3 h-fit text-center mb-20"}>
                    <div className={"w-full h-full flex flex-row gap-10 justify-center items-baseline pt-20"}>
                        <div className={`w-1/3 hover:scale-102 transition-all duration-300 border shadow-2xl bg-studogrey/10 backdrop-blur-2xl rounded-3xl
                ...
                <div className={"w-1/2 h-35 text-white mb-10 px-25 flex p-5 flex-row gap-5 rounded-full bg-studogrey/30 shadow-2xl border border-studoborder"}>
                    <div className={"w-full h-full flex items-center px-10 "}>
                        <div className={"w-full flex flex-col gap-3"}>
                            <span className={"font-bold text-2xl"}>{t("group")}</span>
                            <span className={"text-xl opacity-50"}>{t("korting_school")}</span>
                        </div>
                    </div>
                    <div className={"w-1/3 h-full px-10 flex items-center justify-center"}>
