...
export const mockUser: User = {
    ...
    img_url: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop',
...
export const mockCardsStudyset1: Card[] = [
    {
        id: 'card-001-001',
        term: 'Aorta',
        definition: 'De grootste slagader die zuurstofrijk bloed vanuit het hart naar het lichaam transporteert',
        number: 1,
        created_at: '2026-01-02T14:30:00.000Z',
    ...
    },
    {
        id: 'card-001-002',
        term: 'Ventrikel',
        definition: 'Hartkamer - de onderste holtes van het hart die bloed wegpompen',
        number: 2,
    ...
    },
    {
        id: 'card-001-004',
        term: 'Sinusknoop',
        definition: 'De natuurlijke pacemaker van het hart die elektrische impulsen genereert',
        number: 4,
    ...
    },
    {
        id: 'card-001-005',
        term: 'Mitralisklep',
        definition: 'Klep tussen linker boezem en linker kamer die terugstroom voorkomt',
        number: 5,
...
export const mockCardsStudyset3: Card[] = [
    {
        ...
        definition: 'Begin van de Tweede Wereldoorlog - Duitsland valt Polen binnen',
        number: 1,
        created_at: '2025-12-20T11:00:00.000Z',
...
export const mockClassActivities: ClassActivity[] = [
    {
        ...
        img_url: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop',
        set_id: 'studyset-001-uuid',
        set_type: 'studyset',
        title: 'Het Menselijk Hart',
    ...
    },
    {
        ...
        img_url: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop',
        set_id: 'studyset-002-uuid',
        set_type: 'studyset',
        title: 'Franse Werkwoorden - Passé Composé',
