              ...
              <div className="h-fit w-full md:w-1/2 justify-center relative gap-6 z-10 flex flex-col">
                ...
                >
                  <AnimateOnMount delay={300}>
                    <div
                      className={`flex flex-col gap-5 transition-all duration-500 delay-300`}
                    >
                      <div
                        className={
                          "w-full flex flex-col gap-4 transition-all duration-500 delay-300"
                        }
                      >
                        <span
                          className={
                            "w-full dark:text-white text-studodarkblue text-sm opacity-50"
                          }
                        >
                          {t("info_title")}
                        </span>
                      ...
                      <div
                        className={`w-full flex flex-col gap-4 transition-all duration-500 delay-300`}
                      >
                        <span
                          className={
                            "w-full dark:text-white text-studodarkblue text-sm opacity-50"
