...
export default function SettingsPopup() {
  return (
    <div
      className="inline-flex active:scale-95 transition-[scale] duration-300 cursor-pointer flex-row items-center gap-[0.6em] min-h-9 min-w-9 sm:min-h-10 sm:min-w-10
