    ...
    <div className="flex flex-col gap-10 w-full max-w-2xl 2xl:max-w-4xl px-10">
      <AnimateOnMount className="w-full">
        <div className="w-full h-150">
          <div className="side-a animate__fadeInLeft animate__animate backface-hidden top-0 left-0 absolute w-full shadow-2xl h-full flex items-center justify-center rounded-4xl border border-neutral-200/30 bg-linear-45 from-studogrey/30 to to-zinc-200/30 dark:to-zinc-400/20">
