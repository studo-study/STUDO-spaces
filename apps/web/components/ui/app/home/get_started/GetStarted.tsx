        ...
        <section className="flex flex-col gap-5 overflow-visible">
            ...
            <Container height={"fit"}>
                <div className={"grid grid-cols-2 gap-5"}>
                    <Link href={"/create-studoset"} className={"min-w-full h-full flex items-center justify-center"}>
                        <BaseButton rounded={"xl"}
                                    label={t("studoset_btn_lbl")}
                                    width={"100%"}
                                    bg={"bg-emerald-400"}
                                    iconLeft={
                                        <Image src={"/icons/studyset.svg"}
                                               alt={"icon"}
                                               width={0}
                                               height={0}
                    ...
                    <Link href={"/create-visualset"} className={"min-w-full h-full flex items-center justify-center"}>
                        <BaseButton rounded={"xl"}
                                    label={t("visualset_btn_lbl")}
                                    width={"100%"}
                                    bg={"bg-studoblue"}
                                    iconLeft={
                                        <Image src={"/icons/visualset.svg"}
                                               alt={"icon"}
                                               width={0}
                                               height={0}
                                               className={"w-5 dark:invert dark:brightness-0"}/>
