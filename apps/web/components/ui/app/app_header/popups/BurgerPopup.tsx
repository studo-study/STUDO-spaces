...
const MenuItem = ({ item, showText, t }: MenuItemProps) => (
  <div className="w-full h-10 flex flex-row items-center">
    ...
    <span
      className={`dark:text-white whitespace-nowrap transition-all duration-200
...
export default function UserPopup({ burgerOpen }: UserPopupProps) {
  ...
  return (
    <div className="w-full px-5 relative h-10 opacity-50">
      {burgerOpen ? (
        <div
          className={`absolute bottom-0 left-5 right-5 transition-all duration-300 ease-out
        ...
        >
          ...
          <div className="w-full flex flex-row items-center">
            ...
            <div className="w-full flex flex-row justify-between dark:text-white items-center">
              <span
                className={`whitespace-nowrap transition-all duration-200 delay-150
