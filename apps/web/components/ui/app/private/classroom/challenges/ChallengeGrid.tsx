...
import {
  mockChallenges,
  mockFullClassrooms,
} from "@/data/mocks/classroomsMock";
    ...
    <div className={"w-full h-full flex flex-col scroll-hidden"}>
      <div className={"w-full h-full flex flex-col"}>
        <div className={"w-full gap-5 flex flex-col"}>
          <span
            className={
              "text-studodarkblue dark:text-white flex items-center gap-2 font-bold"
            }
          >
            <HiLightningBolt />
            {t("running")}:
        ...
        <div className={"grid grid-cols-2 min-w-full h-full gap-5 w-full"}>
          ...
          >
            ...
            <div
              className={
                "w-full h-full overflow-y-auto flex flex-col gap-3 py-4"
              }
            >
              {fullClassroom
...
function ChallengePopup({
  ...
  return (
    <div
      className={`fixed inset-0 flex items-start justify-center pt-24 md:pt-32 lg:pt-50 w-full bg-black/50 h-full z-[9999] px-4 md:px-8 lg:px-0
