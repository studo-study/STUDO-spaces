...
import InviteItem from "@/components/ui/app/private/classroom/header/InviteItem";
...
export default function InvitePeople({
  ...
  return (
    <div
      className={`fixed inset-0 flex items-baseline justify-center pt-70 w-full bg-black/50 h-full z-[9999] ${inviteOpen ? "opacity-100" : "pointer-events-none opacity-0"}`}
    >
      <div
        ref={popupRef}
