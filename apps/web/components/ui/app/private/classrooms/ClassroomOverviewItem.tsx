...
export default function ClassroomOverviewItem({
  t,
  classroom,
}: ClassroomOverviewItemProps) {
  return (
    <Link
    ...
    >
      <div
        className={
          "w-full flex flex-row items-center gap-5 dark:text-white text-studodarkblue"
        }
      >
        <div
          className={
            "w-12 h-12 rounded-full bg-white dark:bg-studogrey flex items-center justify-center dark:text-white text-studodarkblue "
          }
        >
        ...
        <div className={"flex flex-col"}>
          <span
            className={
              "w-fit font-bold h-full flex items-center truncate overflow-hidden"
            }
          >
            {classroom.name}
          </span>
          <div
            className={
              "w-fit flex flex-row text-xs items-center gap-1 opacity-50"
            }
          >
            ...
            <span>
              {classroom.users.length +
                " " +
                (classroom.users.length != 1 ? t("members") : t("member"))}
            </span>
          </div>
        </div>
      </div>
