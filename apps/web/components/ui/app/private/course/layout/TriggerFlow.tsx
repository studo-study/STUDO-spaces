...
const TriggerFlow = (props: TriggerFlowProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 shadow-2xl bg-rose-500 min-h-7 min-w-7 text-xl flex items-center justify-center text-white rounded-full border border-studoborder">
        <IoIosAdd />
      </div>
    </button>
  );
