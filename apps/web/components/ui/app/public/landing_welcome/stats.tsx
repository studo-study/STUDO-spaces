  ...
  return (
    <AnimateOnScroll>
      <section className="w-full max-w-screen flex justify-center items-center md:px-20 lg:mb-20">
        <ul className="flex flex-col md:flex-row items-center justify-center gap-4 w-fit md:min-w-[40%] rounded-3xl md:rounded-full bg-gradient-to-r from-emerald-400 to-emerald-500 dark:bg-none dark:glass-rgb border border-neutral-200/20 py-4 px-6 md:px-8 shadow-lg list-none">
