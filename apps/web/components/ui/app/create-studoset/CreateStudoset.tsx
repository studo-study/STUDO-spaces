...
export default function CreateStudosetForm() {
  ...
  const handleForm = async (e?: React.FormEvent) => {
    ...
    const body = {
      ...
      global_definition_language:
        defLangRef.current && defLangRef.current.value,
  ...
  useKeyboardShortcut("i", () => toggleImporter(), {
    ctrl: true,
    always: true,
  });
        ...
        <div className="flex w-full flex-col items-center justify-center gap-3">
          ...
          <div className="w-full gap-3 sm:gap-4 md:gap-5 flex-col flex">
            <div className="flex flex-col gap-1">
              ...
              <div className="h-5">
                <span
                  className={`w-full h-fit text-rose-500 px-5 ${error ? "flex" : "hidden pointer-events-none"}`}
                >
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-5 w-full">
              ...
              <div className="w-full sm:w-1/2 gap-1 flex flex-col h-fit">
                <select
                  ref={folderRef}
                  className={
                    "h-12 px-5 gap-5 text-white cursor-pointer w-full rounded-4xl glass-rgb transition-all duration-300 border appearance-none border-studoborder/30 shadow-2xl focus:ring-0 outline-none flex justify-around"
                  }
              ...
              <div className="w-full sm:w-1/2 gap-1 flex flex-col">
                ...
                <div className="h-5">
                  <span
                    className={`w-full h-fit text-rose-500 px-5 ${error ? "flex" : "hidden pointer-events-none"}`}
                  >
                    {errors.term_lang && t(errors.term_lang)}
                  </span>
                </div>
              </div>
              ...
              <div className="w-full sm:w-1/2 gap-1 flex flex-col">
                ...
                <div className="h-5">
                  <span
                    className={`w-full h-fit text-rose-500 px-5 ${error ? "flex" : "hidden pointer-events-none"}`}
                  >
                    {errors.def_lang && t(errors.def_lang)}
                  </span>
                </div>
              </div>
            </div>
