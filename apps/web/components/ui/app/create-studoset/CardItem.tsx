...
export default function CardItem({
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="w-full h-10 sm:h-[52px] rounded-t-3xl bg-gray-700/50 flex justify-between items-center p-2 px-4 sm:p-3 sm:px-6 md:px-8 overflow-hidden">
      ...
      <div className="absolute w-full flex items-center justify-center -bottom-2.5">
        <div className="relative cursor-pointer bg-blue-500 min-h-[28px] min-w-[28px] flex items-center justify-center text-xl text-white rounded-full border border-studoborder opacity-0 -translate-y-1 hover:opacity-100 hover:translate-y-0 duration-300 active:scale-95 transition-all z-10">
          <IoIosAdd />
        </div>
      </div>
    </div>
