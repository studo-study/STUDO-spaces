...
import TriggerTools from "@/components/ui/marketing/landing_header/dropdowntools";
import TriggerMethods from "@/components/ui/marketing/landing_header/dropdownmethods";
          ...
          <div className="flex items-center justify-start gap-4 lg:gap-10 min-w-0 flex-1">
            ...
            >
              <Image
                ...
                height={0}
                width={0}
                className={"dark:block hidden w-13"}
              />
              <Image
                src={"/logo/hat_light.svg"}
                alt={"hat"}
                height={0}
                width={0}
              ...
              <div className={"flex flex-col gap-3"}>
                ...
                <div className={"w-full h-fit grid grid-cols-2 gap-3"}>
                  {menuItems.map((item) => (
                    ...
                    `}
                      style={{
                        transitionDelay: MethodsOpen
                          ? `${(currentIndex + 1) * 50 + catIndex * 50}ms`
                          : "0ms",
                      }}
                    >
                      {/* Icon Container */}
...
function specialeDag(locale: string) {
  ...
  const feestdagen = {
    ...
    labour:
      "from-red-600 via-red-500 to-red-400 dark:from-white dark:to-red-200",
    valentine:
      "from-pink-600 via-pink-500 to-pink-400 dark:from-white dark:to-pink-200",
    halloween:
    ...
    belgie:
      "from-zinc-900 via-amber-300 to-rose-700 dark:from-zinc-900 dark:via-amber-400 dark:to-rose-600",
  ...
  return (
    vasteDagen[key] ||
    "from-emerald-400 to-emerald-400 dark:from-white dark:to-blue-200"
  );
}
