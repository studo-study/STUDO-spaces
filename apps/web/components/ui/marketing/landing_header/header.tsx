                ...
                >
                    ...
                    `}
                                        ...
                                        >
                                            ...
                                            >
                                                <Image src={item.icon} alt={item.label + " icon"} width={12} height={12}
                    ...
                    `}
                                            ...
                                            >
                                                ...
                                                <div className="flex flex-col">
													  <span
                                                          className="font-medium w-full truncate overflow-hidden text-sm group-hover:text-studodarkblue dark:group-hover:text-white transition-colors">
														{t(item.label)}
													  </span>
                                                </div>
...
function specialeDag() {
    ...
    return vasteDagen[key] || "from-emerald-400 to-emerald-400 dark:from-white dark:to-blue-200";
}
