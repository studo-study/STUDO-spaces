...
const SmallProgress = (props: SmallProgressProps) => {
    ...
    return (<div className={"flex flex-row gap-2 w-full items-center"}>
        <div className={"w-3/4 flex items-center min-h-1.5 rounded-full bg-studogrey/30"}>
            <div
        ...
        <span className={"w-1/4 text-xs dark:text-white text-studodarkblue font-bold"}>{prog}%</span>
    </div>)
}
