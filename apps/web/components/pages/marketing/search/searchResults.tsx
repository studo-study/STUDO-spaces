...
import SearchResultClassroom from "@/components/pages/marketing/search/classrooms/searchresult_classroom";
import SearchResultSets from "@/components/pages/marketing/search/sets/searchresult_sets";
import SearchResultUsers from "@/components/pages/marketing/search/users/searchresult_users";
import SearchResultStudo from "@/components/pages/marketing/search/studo/searchresult_studo";
import NoResult from "@/components/pages/marketing/search/noresult";
