...
const COLORS: FlowColor[] = [
    { name: "emerald", bg: "bg-emerald-400/20", text: "text-emerald-500", dot: "bg-emerald-500", ring: "ring-emerald-500" },
    { name: "blue",    bg: "bg-blue-400/20",    text: "text-blue-500",    dot: "bg-blue-500",    ring: "ring-blue-500" },
    { name: "violet",  bg: "bg-violet-400/20",  text: "text-violet-500",  dot: "bg-violet-500",  ring: "ring-violet-500" },
    { name: "rose",    bg: "bg-rose-400/20",    text: "text-rose-500",    dot: "bg-rose-500",    ring: "ring-rose-500" },
    { name: "amber",   bg: "bg-amber-400/20",   text: "text-amber-500",   dot: "bg-amber-500",   ring: "ring-amber-500" },
    { name: "cyan",    bg: "bg-cyan-400/20",    text: "text-cyan-500",    dot: "bg-cyan-500",    ring: "ring-cyan-500" },
    { name: "orange",  bg: "bg-orange-400/20",  text: "text-orange-500",  dot: "bg-orange-500",  ring: "ring-orange-500" },
    { name: "pink",    bg: "bg-pink-400/20",    text: "text-pink-500",    dot: "bg-pink-500",    ring: "ring-pink-500" },
];
