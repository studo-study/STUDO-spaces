...
const BreadCrumbs = (props: BreadCrumbsProps) => {
    ...
    return (<div
        ...
        <Link href={"/flow/" + board_id + "/" + course_id}
            className={"text-xs px-3 py-1 border hover:underline border-studoborder/30 rounded-xl bg-studogrey/50 font-bold text-studodarkblue dark:text-white"}> {course_title}</Link>
    </div>)
}
