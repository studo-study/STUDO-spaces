...
const ResourceIcon = (props: ResourceIconProps) => {
    ...
    return (<div
        className={"min-w-fit truncate flex hover:border-studoborder flex-row gap-1 text-xs items-center px-2 rounded-full border border-studoborder/30 py-0.5 bg-studogrey/30"}
