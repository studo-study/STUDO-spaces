// app/studosets/[flow_id]/page.tsx
...
export default async function StudosetPage({params}: {
    ...
    if (session) {
        return <div className={"w-full h-full flex items-center justify-center pt-20 dark:text-white text-studodarkblue"}>
            <div className="flex w-full h-full sm:w-11/12 md:w-4/5 lg:w-3/5 max-w-[700px] flex-col gap-3 sm:gap-5">
                <StudosetView id={id} />
            </div>
        </div>
    }
