  ...
  return (
    <div className="w-full h-full py-15 bg-radial from-blue-500/10 via-transparent to-transparent flex flex-col items-center gap-10 scroll-hidden">
      ...
      >
        ...
        <h1
          className={
            "font-sfpro gap-3 justify-center items-center dark:text-white flex text-studodarkblue  font-bold"
          }
        >
          <span
            className={
          ...
          <span
            className={
              "text-3xl h-fit bg-clip-text text-transparent truncate bg-linear-to-r from-indigo-300 to-blue-300"
            }
          >
            select
          </span>
      ...
      <span
        className={
          "w-2/3 h-fit dark:text-white/30 text-center text-xl font-semibold text-studodarkblue "
        }
      >
        {t("plan")}
      </span>
      <div
        className={
          "w-full h-full flex flex-row gap-10 justify-center items-baseline pt-20"
        }
      >
        <div
          className={`w-1/3 hover:scale-102 transition-all duration-300 border shadow-2xl bg-studogrey/10 rounded-3xl
        ...
        <div
          className={`w-2/5 cursor-pointer hover:scale-102 transition-all duration-300 border shadow-2xl bg-linear-to-br from-gray-300/10 via-white/10 to-gray-400/10 rounded-3xl
