...
export default function StreakPage() {
    ...
    const Streak = 32;
    return (<div className="w-full h-full py-15 bg-radial from-orange-300/10 via-transparent to-transparent flex flex-col justify-center items-center gap-10 scroll-hidden">
          ...
          {Streak}</span>
                    ...
                    <span className="font-atrament font-sfpro font-bold text-3xl text-orange-400">{t('d_s')}</span>
                    <span className="font-sfpro text-xl text-gray-400">
          {t('phrase_1')}{Streak}{t('phrase_2')}.
        </span>
                    <span className="font-sfpro text-xl text-gray-400">
          {Phrases()}!
        </span>
