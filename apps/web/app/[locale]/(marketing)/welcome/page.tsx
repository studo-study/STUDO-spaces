import Hero from "@/components/pages/marketing/landing_welcome/hero";
import Info from "@/components/pages/marketing/landing_welcome/info";
import Stats from "@/components/pages/marketing/landing_welcome/stats";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
    ...
    const messages = (await import(`../../../../messages/seo/welcome/${locale}.json`)).default;
