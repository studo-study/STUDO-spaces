      ...
      <div className="max-w-4xl mx-auto flex flex-col gap-12">
        ...
        <AnimateOnMount delay={300} className="w-full">
          <section className="flex flex-col gap-4">
            ...
            <p className="text-lg leading-relaxed">{t("supportText")}</p>
            <p className="text-lg">
        ...
        <AnimateOnMount delay={400} className="w-full">
          <section className="flex flex-col gap-4">
            ...
            <p className="text-lg leading-relaxed">{t("businessText")}</p>
            <p className="text-lg">
              <span className="font-bold">Email: </span>

              <a
                href="mailto:business@studo.study"
                className="text-emerald-500 dark:text-studoblue hover:underline"
              >
        ...
        <AnimateOnMount delay={500} className="w-full">
          <section className="flex flex-col gap-4">
            ...
            <p className="text-lg leading-relaxed">{t("pressText")}</p>
            <p className="text-lg">
              <span className="font-bold">Email: </span>

              <a
                href="mailto:press@studo.study"
                className="text-emerald-500 dark:text-studoblue hover:underline"
              >
                press@studo.study
              </a>
        ...
        <AnimateOnMount delay={600} className="w-full">
          <section className="flex flex-col gap-4">
            ...
            <p className="text-lg leading-relaxed">{t("feedbackText1")}</p>
            <p className="text-lg leading-relaxed">{t("feedbackText2")}</p>
            <p className="text-lg">
              <span className="font-bold">Email: </span>

              <a
                href="mailto:feedback@studo.study"
                className="text-emerald-500 dark:text-studoblue hover:underline"
              >
        ...
        <AnimateOnMount delay={700} className="w-full">
          <section className="flex flex-col gap-4">
            ...
            <p className="text-lg leading-relaxed">{t("bugText")}</p>
        ...
        <AnimateOnMount delay={800} className="w-full">
          <section className="flex flex-col gap-4">
            ...
            <p className="text-lg leading-relaxed">{t("socialText")}</p>
            <div className="flex flex-col gap-2">
              ...
              <p className="text-lg">
                ...
                <a
                  href="https://linkedin.com/company/studo"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-emerald-500 dark:text-studoblue hover:underline"
                >
        ...
        <AnimateOnMount delay={900} className="w-full">
          <section className="flex flex-col gap-4 mb-20">
            ...
            <p className="text-lg leading-relaxed">{t("responseText1")}</p>
            <p className="text-lg leading-relaxed">{t("responseText2")}</p>
          </section>
        </AnimateOnMount>
      </div>
    </main>
