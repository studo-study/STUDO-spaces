...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
    ...
    const messages = (await import(`../../../../messages/seo/terms-of-service/${locale}.json`)).default;
        ...
        >
            <div className="max-w-4xl mx-auto flex flex-col gap-10">
                ...
                <AnimateOnMount delay={300} className="w-full">
                    <section className="flex flex-col gap-4">
                        ...
                        <ul className="flex flex-col gap-2 pl-5">
                            ...
                            <li className="list-disc">{t("acceptableUse.rules.impersonate")}</li>
                            <li className="list-disc">{t("acceptableUse.rules.shareCredentials")}</li>
                            <li className="list-disc">{t("acceptableUse.rules.spam")}</li>
                            <li className="list-disc">{t("acceptableUse.rules.viruses")}</li>
                            <li className="list-disc">{t("acceptableUse.rules.circumvent")}</li>
                        </ul>
                        <p className="text-base leading-relaxed">
                ...
                <AnimateOnMount delay={450} className="w-full">
                    <section className="flex flex-col gap-4">
                        <h2 className="font-bold text-2xl">{t("intellectualProperty.title")}</h2>
                        <p className="text-base leading-relaxed">
                ...
                <AnimateOnMount delay={550} className="w-full">
                    <section className="flex flex-col gap-4">
                        ...
                        <ul className="flex flex-col gap-2 pl-5">
                            <li className="list-disc">{t("availability.reasons.maintenance")}</li>
                            <li className="list-disc">{t("availability.reasons.technical")}</li>
                            <li className="list-disc">{t("availability.reasons.circumstances")}</li>
                        </ul>
                        <p className="text-base leading-relaxed">
                ...
                <AnimateOnMount delay={600} className="w-full">
                    <section className="flex flex-col gap-4">
                        ...
                        <ul className="flex flex-col gap-2 pl-5">
                            <li className="list-disc">{t("disclaimer.noGuarantee.requirements")}</li>
                            <li className="list-disc">{t("disclaimer.noGuarantee.errorFree")}</li>
                            <li className="list-disc">{t("disclaimer.noGuarantee.accurate")}</li>
                            <li className="list-disc">{t("disclaimer.noGuarantee.success")}</li>
                        </ul>
                        <p className="text-base leading-relaxed">
                ...
                <AnimateOnMount delay={650} className="w-full">
                    <section className="flex flex-col gap-4">
                        ...
                        <ul className="flex flex-col gap-2 pl-5">
                            ...
                            <li className="list-disc">{t("liability.damages.interruptions")}</li>
                        </ul>
                        <p className="text-base leading-relaxed">
                ...
                <AnimateOnMount delay={700} className="w-full">
                    <section className="flex flex-col gap-4">
                        ...
                        <ul className="flex flex-col gap-2 pl-5">
                            ...
                            <li className="list-disc">{t("indemnification.claims.content")}</li>
                            <li className="list-disc">{t("indemnification.claims.violation")}</li>
                            <li className="list-disc">{t("indemnification.claims.rights")}</li>
                        </ul>
                    </section>
                </AnimateOnMount>
                ...
                <AnimateOnMount delay={750} className="w-full">
                    <section className="flex flex-col gap-4">
                        ...
                        <ul className="flex flex-col gap-2 pl-5">
                            ...
                            <li className="list-disc">{t("termination.reasons.discontinue")}</li>
                        </ul>
                        <p className="text-base leading-relaxed">
                    ...
                    <section className="flex flex-col gap-4">
                        ...
                        <p className="text-base leading-relaxed">
                            {t.rich("governingLaw.eu", {
                                link: (chunks) => <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="text-emerald-500 dark:text-studoblue hover:underline">{chunks}</a>
                            })}
                        </p>
                    </section>
                </AnimateOnMount>
                ...
                <AnimateOnMount delay={900} className="w-full">
                    <section className="flex flex-col gap-4">
                        ...
                        <ul className="flex flex-col gap-3 pl-5">
                            <li className="list-disc">{t.rich("miscellaneous.entireAgreement", {
                                bold: (chunks) => <span className="font-bold">{chunks}</span>
                            })}</li>
                            <li className="list-disc">{t.rich("miscellaneous.severability", {
                                bold: (chunks) => <span className="font-bold">{chunks}</span>
                            })}</li>
                            <li className="list-disc">{t.rich("miscellaneous.noWaiver", {
                                bold: (chunks) => <span className="font-bold">{chunks}</span>
                            })}</li>
                            <li className="list-disc">{t.rich("miscellaneous.assignment", {
                                bold: (chunks) => <span className="font-bold">{chunks}</span>
                            })}</li>
                        </ul>
                    </section>
                ...
                <AnimateOnMount delay={950} className="w-full">
                    <section className="flex flex-col gap-4 mb-20">
                        ...
                        <div className="flex flex-col gap-2 bg-studodarkblue/5 dark:bg-white/5 p-4 rounded-xl">
                            ...
                            <p><span className="font-bold">{t("contact.website")}</span> <a href="https://studo.study" className="text-emerald-500 dark:text-studoblue hover:underline">studo.study</a></p>
                        </div>
                    </section>
                </AnimateOnMount>
