...
import BlogItem from "@/components/ui/marketing/blog/BlogItem";

export async function generateMetadata({params}: { params: Promise<{ locale: string }> }) {
    const {locale} = await params;
    const messages = (await import(`../../../../messages/seo/faq/${locale}.json`)).default;
...
const FAQ_CATEGORIES = [
    ...
    { key: "studosets", questions: ["q1", "q2", "q3", "q4", "q5"], isOpen: false },
    { key: "classrooms", questions: ["q1", "q2", "q3", "q4", "q5"], isOpen: false },
