...
export async function generateMetadata({
  ...
  return buildSeoMetadata("time-attack", "/challenges/time-attack", locale);
}
            ...
            {launched && (
              <AnimateOnMount delay={1000} className={"w-full"}>
                ...
                >
                  <Link
                    href="/register"
                    className="px-6 py-3 rounded-full flex items-center justify-center text-white bg-red-400 font-bold"
                  >
                    {t("cta")}
                  </Link>
                </div>
