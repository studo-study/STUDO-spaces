    ...
    <section className="relative w-full max-w-screen overflow-visible h-fit xxl:h-3/4 flex flex-col items-center justify-start pt-10 px-4">
      ...
      <div className="relative z-10 flex flex-col 3xl:min-h-screen items-center text-center pt-15 sm:pt-15 lg:pt-20 3xl:pt-30 overflow-visible gap-8 3xl:w-2/3 max-w-screen">
        ...
        <AnimateOnMount delay={200}>
          <p className="text-lg md:text-2xl text-studodarkblue/70 dark:text-white/70 max-w-2xl">
            {t("Subtitle")}
          </p>
        </AnimateOnMount>
        ...
        >
          ...
          <nav className="grid grid-cols-1 md:grid-cols-2 gap-4 md:mt-6 md:w-full max-w-150">
            <Link
              href={"/register"}
              className="px-8 py-4 text-lg flex items-center justify-center gap-2 font-bold text-white bg-emerald-400 dark:bg-studoblue rounded-full border-2 border-emerald-400 dark:border-studoblue hover:bg-emerald-500 dark:hover:bg-studoblue/50 transition-all duration-300"
            >
              {t("SignUp")}
            ...
            <Link
              href="/welcome#info"
              className="px-8 py-4 text-lg flex items-center justify-center gap-2 font-bold text-emerald-400 dark:text-studoblue rounded-full border-2 border-emerald-400 dark:border-studoblue bg-transparent hover:bg-emerald-400/10 dark:hover:bg-studoblue/10 transition-all duration-300 "
            >
              {t("LearnMore")}
