          ...
          <div className="w-full h-full backdrop-blur-2xl flex flex-col overflow-y-auto">
            <div className="w-full flex-1 flex flex-col items-center justify-start sm:justify-center px-12 py-8 sm:py-16">
              <div className="w-full md:w-1/2 flex flex-col gap-4 sm:gap-6">
                ...
                >
                  <h1 className="text-3xl sm:text-4xl font-bold text-studodarkblue dark:text-white">
                    {t("Create account")}
                  </h1>
                ...
                >
                  <div
                    className={`flex flex-col gap-2 sm:gap-3 transition-all duration-500 delay-300
                    ${mounted ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-4"}`}
                  >
                    {/* Email Input */}
                    <div className="flex flex-col gap-1">
                      ...
                      <span
                        className="text-red-400 h-4 sm:h-5 text-xs px-4"
                        data-cy="email_error"
                      >
                  ...
                  <span
                    className="text-red-400 h-5 text-sm px-4"
                ...
                <div
                  className={`flex flex-col gap-3 sm:gap-4 transition-all duration-500 delay-500
                  ${mounted ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-4"}`}
                >
