...
export default function Item({ set }) {
  ...
  return (
    <Link to={"/((visualset))/" + set.id}>
      <div
        className="flex justify-between w-full min-h-16 sm:min-h-18 md:min-h-20 max-h-20
      ...
      >
        <div className="flex items-center justify-start gap-3 sm:gap-5 w-full min-w-0">
          <div
            className="w-12 h-12 sm:w-14 sm:h-14 dark:bg-studogrey rounded-full bg-white
