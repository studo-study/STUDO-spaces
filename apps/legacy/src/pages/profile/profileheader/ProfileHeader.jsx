...
export default function ProfileHeader({ profile }) {
  ...
  return (
    <div
      className="flex flex-col mt-10 md:mt-0 sm:flex-row justify-start sm:justify-baseline items-center md:items-start
    ...
    >
      <div className="flex justify-center items-center w-full h-full md:w-fit md:h-fit">
        <div
          className="bg-green-300 rounded-full h-16 w-16 sm:h-20 sm:w-20 md:h-22 md:w-22
      ...
      <div className="flex flex-col gap-2 sm:gap-3 w-full min-w-0 items-center justify-center md:items-baseline md:justify-center">
        ...
        <div className="flex flex-row justify-start items-center gap-2 sm:gap-3 flex-wrap">
          <img
            className="h-4 sm:h-5 dark:brightness-0 dark:invert flex-shrink-0"
            src={Cal}
            alt="calendar icon"
          />
