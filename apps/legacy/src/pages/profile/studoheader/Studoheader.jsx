...
export default function Studoheader({ profile }) {
  ...
  return (
    <div
      className="relative w-full h-60 sm:h-72 md:h-80 flex justify-center
    ...
    >
      ...
      <div
        className="absolute bottom-0 z-50 flex flex-row items-center
      ...
      >
        <div className="flex flex-col gap-2 sm:gap-3 w-full">
          <div className="flex flex-row items-center gap-2 sm:gap-3 relative flex-wrap">
            <div
              className="h-10 w-10 sm:h-12 sm:w-12 rounded-full bg-studogrey dark:bg-white
            ...
            <span className="font-akira text-lg sm:text-xl md:text-2xl dark:text-white">
              STUDO
            </span>
