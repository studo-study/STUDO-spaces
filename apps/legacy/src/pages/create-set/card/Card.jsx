...
const Card = memo(function Card({ index, disabled, onRemove }) {
  ...
  return (
    ...
    >
      <div
        className="w-full h-10 sm:h-13 bg-studowhite flex flex-row justify-between
        items-center p-2 px-4 sm:p-3 sm:px-6 md:px-8 border-0 border-solid border-b-2
        dark:border-gray-500 border-gray-300"
      >
        <span className="text-studodarkblue dark:text-white text-sm sm:text-base">
          {index + 1}
        </span>
      ...
      <div className="flex flex-col lg:flex-row w-full gap-3">
          ...
          <div className="flex flex-col gap-1">
            <input
              {...register(`cardlist.0.cards.${index}.term`, {
                ...
                maxLength: {
                  value: 128,
                  message: t("Term max 128 characters"),
                },
              })}
              type="text"
            ...
            />
            {cardErrors?.term && (
              <span className="text-red-500 text-xs sm:text-sm pl-4">
        ...
        <div className="flex flex-col sm:flex-row justify-between w-full pb-4 sm:pb-6 md:pb-8 p-3 gap-3 sm:gap-6 md:gap-9 px-4 sm:px-6 md:px-8">
            ...
            <div className="flex flex-col gap-1">
              <input
                {...register(`cardlist.0.cards.${index}.definition`, {
                  ...
                  maxLength: {
                    value: 128,
                    message: t("Definition max 128 characters"),
                  },
                })}
                type="text"
                className="px-3 sm:px-[2vh] h-10 sm:h-12 rounded-full text-sm sm:text-base border-0
