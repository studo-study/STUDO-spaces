  ...
  return (
    <div
      ...
      className={`w-full flex flex-col justify-center items-center gap-2 sm:gap-3 
        bg-studowhite cursor-pointer
        gap-3 sm:gap-5 border-1 border-transparent border-studoborder rounded-2xl sm:rounded-4xl
        shadow-[8px_8px_16px_#bebebe,-8px_-8px_16px_#bebebe] 
        p-3 sm:p-4 md:p-5 pb-2 backdrop-blur-xs
      ...
      <div className="neu-wrapper relative w-full">
        ...
        >
          ...
          <g id="Layer_1-2" data-name="Layer 1">
            <path
              className="cls-1 stroke-[#1112] dark:stroke-studodarkblue"
              d="M50,557.89c0-280.5,227.39-507.89,507.89-507.89s507.9,227.39,507.9,507.89"
            />
            <path
              className={`cls-2 
                ${type === "Niet gestudeerd" || type === "Not Studied" ? "stroke-studoblue" : ""} 
