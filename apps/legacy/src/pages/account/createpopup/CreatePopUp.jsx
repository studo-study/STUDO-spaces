  ...
  return (
    ...
    >
      <Link to="/create-set" className="w-full">
        <div className="flex items-center justify-start w-full sm:w-40 h-10 sm:h-12
          ...
          <img src={studyset} alt="" className="h-5 sm:h-6 mr-2 dark:invert dark:brightness-0" />
          {t("STUDYSET")}
        </div>
      </Link>
      ...
      <Link to="/create-visualset" className="w-full">
        <div className="flex items-center justify-start w-full sm:w-40 h-10 sm:h-12
          ...
          cursor-pointer select-none transition-transform duration-300 ease-out
          hover:scale-105 dark:text-white px-3">
          <img src={visual} alt="" className="h-5 sm:h-6 mr-2 dark:invert dark:brightness-0" />
          {t("VISUALSET")}
        </div>
      </Link>
    </div>
