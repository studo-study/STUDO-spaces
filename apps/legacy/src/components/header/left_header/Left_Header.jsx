...
export default function Left_Header({ onBurgerClick }) {
  ...
  return (
    <div
      className="flex justify-around items-center backdrop-blur-2xl h-16 sm:h-22 min-w-fit gap-2 sm:gap-5
    ...
    >
      <div
        className="dark:bg-transparent bg-studogrey w-12 sm:w-15 h-10 sm:h-13 rounded-3xl
        pl-1 sm:pl-2 pb-1 items-center flex justify-center"
      >
        <div
          className="nav stroke-[#2a3a42] dark:stroke-white"
          id="burger-toggle"
        >
      ...
      <Link
        to="/home"
        className={`font-akira text-3xl sm:text-5xl bg-gradient-to-r ${specialeDag()}
...
function specialeDag() {
  ...
  const feestdagen = {
    ...
    carnival:
      "from-fuchsia-600 via-fuchsia-500 to-fuchsia-400 dark:from-white dark:to-fuchsia-200",
    kingsDay:
