  ...
  return (
    <div className="flex justify-center items-center h-16 sm:h-[88px] w-auto gap-3 sm:gap-8 pr-2 sm:pr-10">
      <div className="relative">
        ...
        <div
          className="relative w-10 h-10 sm:w-12 sm:h-12 bg-studoblue rounded-full flex items-center justify-center
      ...
      <div className="relative w-10 h-10 sm:w-12 sm:h-12 ">
        ...
        >
          ...
          {user.streak_count > 3 && (
            <div
              className="absolute -right-0.5 sm:-right-1 -bottom-0.5 sm:-bottom-1 w-5 h-5 sm:w-6 sm:h-6
