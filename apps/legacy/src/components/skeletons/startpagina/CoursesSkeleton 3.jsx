export default function CoursesSkeleton() {
  return (
    <div className="relative w-full mt-3 sm:mt-4 md:mt-7 animate-pulse">
      ...
      <div
        className="absolute left-0 top-0 bottom-0 w-3 sm:w-5 md:w-8
        bg-gradient-to-r from-bg-white dark:from-bg-dark to-transparent
        pointer-events-none rounded-l-2xl sm:rounded-l-4xl"
      ></div>

      <div
        className="absolute right-0 top-0 bottom-0 w-6 sm:w-10 md:w-15
        bg-gradient-to-l from-bg-white dark:from-bg-dark to-transparent
        pointer-events-none rounded-r-2xl sm:rounded-r-4xl"
      ></div>
    </div>
  );
}
...
function CourseItemSkeleton() {
  return (
    ...
    >
      ...
      <div
        className="w-16 h-16 sm:w-18 sm:h-18 md:w-22 md:h-22
