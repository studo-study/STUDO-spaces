export default function SetItemSkeleton() {
  return (<div className="flex justify-between min-w-full min-h-20 max-h-20 rounded-full
  bg-studowhite border-transparent border-studoborder
    ...
    <div className="flex items-center justify-between items-center gap-5">
      <div
        className="w-14 h-14 dark:bg-studogrey animate-pulse rounded-full bg-white flex justify-center items-center">
