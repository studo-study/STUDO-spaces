  ...
  const faqs = [
    {
      ...
      answer: t(
        "faq.flashcards.what.answer",
        "Flashcards are a studygroup tool where you have a question or term on one side and the answer on the other. They help with memorization through active recall.",
      ),
    },
    {
      question: t("faq.flashcards.free.question", "Are Studo flashcards free?"),
      answer: t(
        "faq.flashcards.free.answer",
        "Yes, Studo flashcards are 100% free. You can create unlimited flashcard sets and studygroup them anytime.",
      ),
    },
  ];
  ...
  return (
    <>
      <SEO
        ...
        imageAlt={t(
          "seo.flashcards.imageAlt",
          "Studo Flashcards - Interactive studygroup cards",
        )}
