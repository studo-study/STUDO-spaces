...
export default function ThreeDots({ id, onSuccess }) {
  ...
  return (
    <div className="fixed z-[9999]">
      <div className={"h-10 w-10 rounded-full flex items-center  z-[9999] justify-center border border-studogrey/30\n" +
        ...
        <img src={Dots}
             alt="3dots"
             className={"rotate-90 w-8 dark:invert dark:brightness-0 cursor-pointer opacity-50"} />
      </div>
      <DeleteFolder isOpen={isOpen} onClose={closePopup} id={id} onSuccess={onSuccess} />
    </div>
  );
}