  ...
  return (
    ...
    >
      <Link to="/create-set" className="w-full">
        <div className="flex items-center justify-start w-30 h-8 font-atrament text-[#2a3a42]
          ...
          <img src={studyset} alt="" className="h-4 ml-3 mr-2 dark:invert dark:brightness-0" />
          {t("STUDYSET")}
        </div>
      </Link>

      <Link to="/create-visualset" className="w-full">
        <div className="flex items-center justify-start w-30 h-8 font-atrament text-base text-[#2a3a42]
              bg-studogrey rounded-2xl shadow-md
              border-solid border-2 border-studogrey
              cursor-pointer select-none transition-transform duration-300 ease-out
              hover:scale-105 dark:text-white">
          <img src={visual} alt="" className="h-4 ml-3 mr-2 dark:invert dark:brightness-0" />
          {t("VISUALSET")}
        </div>
      </Link>
