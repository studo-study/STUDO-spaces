export default function ProfileHeaderSkeleton() {
  return (<div className="flex flex-row justify-baseline items-center
      ...
      <div className="flex flex-col gap-3">
        ...
        <span className="flex items-center text-2xl
              font-sfpro font-bold text-studodarkblue dark:text-white"></span>
          <div className="animate-pulse bg-studogrey rounded-lg min-h-5 min-w-30"></div>

        </div>
        <div className="animate-pulse bg-studogrey rounded-lg min-h-5 min-w-50">
